...
export function EditCandidateModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/45 p-2 sm:p-6 overflow-x-clip" onClick={e => { if (e.target === e.currentTarget) onClose() }}>
