  ...
  return (
    <CinematicSection variant="band" className="py-12 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 px-6 py-5 rounded-2xl border border-[#F97316]/20 bg-[#166534]/20">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#166534] flex items-center justify-center text-[#F97316] shrink-0">
          ...
          <Link href="/#product" className="text-sm font-semibold text-[#F97316] hover:text-orange-300 whitespace-nowrap">About SRP AI Labs →</Link>
        </div>
      </div>
    </CinematicSection>
  )
