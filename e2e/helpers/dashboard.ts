...
export const DASHBOARD_TABS: { label: string; heading: string | RegExp }[] = [
  ...
  { label: 'AI Screening', heading: /AI Screening|Screen|Match/i },
  { label: 'Boolean Search', heading: /Boolean/i },
  { label: 'AI Composer', heading: /Compose|Composer|Email/i },
  { label: 'JD Writer', heading: /JD|Job Description/i },
