...
|--------|--------|--------------|
| Submission (`SUB-YYYY-######`) | Shipped | `app/api/submissions/**`, `SubmissionsTab` — ops columns + export |
...
| Ops list chrome / clear IDs | Shipped | `OpsListChrome`, `EntityIdLink`, `docs/OPS_LISTS.md` |
